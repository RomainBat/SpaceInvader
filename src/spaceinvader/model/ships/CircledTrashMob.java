...
public class CircledTrashMob extends TrashMob{
    ...
    public CircledTrashMob(Dimension ground, GameLevel level) {
        super(ground, level, "spaceinvader/view/classic_alien_sharpened.png", 2, new CircularMove(), "spaceinvader/view/classic_alien_sharpened_broken.png");
